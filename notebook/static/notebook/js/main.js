...
requirejs(
  ...
  function(
    ...
    var login_widget = new loginwidget.LoginWidget(
      "span#login_widget",
      common_options
    );
    ...
    Promise.all([
      ...
      .catch(function(error) {
        console.error(
          "Could not load nbextensions from user config files",
          error
        );
      })
      ...
      .then(function() {
        if (!utils.is_loaded("jupyter-js-widgets/extension")) {
          ...
          utils
            .load_extension("widgets/notebook/js/extension")
            .catch(function() {
              console.warn(
